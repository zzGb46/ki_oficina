...
<div class="container-fluid">
    <div class="row">
        <div class="col-3">
            ...
            <img class="w-100 h-100" src="http://localhost/kioficina/public/uploads/sem_foto_servico.png"
                ...
                title="Clique na imagem para selecionar uma foto do serviço"
 ...
 <div class="form-group mt-3">
     ...
     <textarea class="form-control" name="descricao_servico" id="descricao_servico" rows="3" required></textarea>
 </div>
 ...
 <div class="row mt-3">
     ...
     <div class="col">
         ...
         <input type="text" class="form-control" placeholder="R$" name="preco_base_servico" id="preco_base_servico" required>
     </div>
 
     <!-- TEMPO -->
     <div class="col">
         <label for="tempo_estimado_servico" class="form-label">Tempo Estimado:</label>
         <input type="time" class="form-control" name="tempo_estimado_servico" id="tempo_estimado_servico">
     </div>
