    ...
    <div class="container">
        ...
        <div class="footer-email" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="100"
            ...
            <div class="footer-heading-email">
                <h5 class="email-title">Inscreva-se em nossa newsletter e receba diretamente no seu e-mail.</h5>
                <div>
                    <p id="ak-alert-footer"></p>
                    <form class="email-form" method="POST" id="footer-email">
                        <input type="text" name="footerEmail" id="footerEmail" placeholder="Informe seu e-mail..."
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="loginModalLabel">Login - KiOficina</h1>
